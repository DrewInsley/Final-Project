...
<span style="color:red">**The number of ladders deployed does match to almost exactly half the amount of fire incidents by borough. In fact, the descending order of counts is the exact same. To further visualize this connection, we can plot ladders and incidents on a scatterplot.**
</span>
```{r}
