...
<span style="color:red">**As the scatterplot shows, there is a clear linear relationship between the two variables. This means that ladders deployed and number of fires are heavily correlated, as expected. Let's take a look at which days these fires were most likely to occur.**</span>
...
<span style="color:red">**Oddly enough, even though the top five worst fire days were in February, the second month actually has the least amount of medical emergencies associated with those fires. In fact, the most medical emergencies come from July. Perhaps the most important thing to observe however is the specific location the most fires occur. One can do this by looking at number of fires by Zip Code.**
</span>
