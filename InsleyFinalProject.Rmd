...
**The most number of fire incidents occured in Brooklyn, with a total count of 777,725 occurances. Let's see if Brooklyn has the highest number of ladders deployed, as would be expected.**
